...
currentYellow = 0   # Indicates whether yellow signal is on or off it
...
class Main:
    ...
    signalCoods = [
    (565, 348),  # Coordinates for the first signal light
    (720, 300),  # Coordinates for the second signal light
    (770, 440),  # Coordinates for the third signal light
    (618, 490)   # Coordinates for the fourth signal light
    ]
...
# Define the box locations for signals and vehicle counts
        signalTimerCoods = [
            (550, 300),  # Coordinates for the first signal
            (815, 300),  # Coordinates for the second signal
            (550, 540),  # Coordinates for the third signal
            (815, 540)   # Coordinates for the fourth signal
        ]

        vehicleCountCoods = [
            (5500, 3000),  # Coordinates for the first vehicle count
            (2000, 1500),  # Coordinates for the second vehicle count
            (3000, 1500),  # Coordinates for the third vehicle count
            (4000, 1500)   # Coordinates for the fourth vehicle count
        ]
...
# Set coordinates to the top left corner
        timeElapsedCoords = (10, 10)  # Adjust the values if you want some padding from the top-left corner
